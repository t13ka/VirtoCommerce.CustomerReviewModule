namespace CustomerReviews.Web
{
    ...
    public class Module : ModuleBase
    {
        private readonly string _connectionString =
            ConfigurationHelper.GetConnectionStringValue("VirtoCommerce.CustomerReviews")
        ...
        public override void Initialize()
        {
            ...
            _container.RegisterType<ICustomerReviewRepository>(
                new InjectionFactory(
                    c => new CustomerReviewRepository(
                        _connectionString,
        ...
        public override void SetupDatabase()
        {
            ...
            {
                var initializer =
                    new SetupDatabaseInitializer<CustomerReviewRepository, Configuration>();
